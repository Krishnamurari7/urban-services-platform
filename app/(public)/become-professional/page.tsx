  ...
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-6 inline-flex items-center rounded-full border bg-background/50 px-4 py-2 text-sm backdrop-blur-sm">
              ...
              <span className="text-muted-foreground">Join 500+ professionals</span>
            </div>
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
              Become a <span className="text-primary">Professional</span>
            </h1>
            <p className="mt-6 text-lg text-muted-foreground sm:text-xl">
              Join thousands of professionals earning a great income by providing
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="mt-12 grid gap-8 lg:grid-cols-2">
        ...
        <div>
          <div className="mb-8">
            <h2 className="mb-2 text-3xl font-bold tracking-tight">Why Join Us?</h2>
      ...
      <section className="mt-16 rounded-lg bg-gradient-to-br from-primary via-primary/95 to-primary/90 p-8 md:p-12 text-center text-primary-foreground">
        ...
        <div className="mt-6">
          {!user ? (
            <Link href="/register">
              <Button size="lg" variant="secondary" className="h-12 px-8 text-base shadow-lg hover:shadow-xl transition-all">
                Create Account
              </Button>
            </Link>
          ) : (
            <Button size="lg" variant="secondary" onClick={handleSubmit} className="h-12 px-8 text-base shadow-lg hover:shadow-xl transition-all">
              Apply Now
            </Button>
          )}
        </div>
